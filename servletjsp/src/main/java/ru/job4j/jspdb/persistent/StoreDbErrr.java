...
public enum StoreDbErrr implements ReStore {
    INSTANCE;
    private static final Logger LOGGER = LoggerFactory.getLogger(StoreDbErrr.class);
...
//            this.config.getProperty(Settings.INITIAL)
        }
    }
...
//            this.config.getProperty(Settings.DROP)
        }
    }
